...
export default function FeaturesForm({ features, updateAction }: FeaturesFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      {features.map((feature) => {
        const key = featureMap[feature.id];
        return (
          <div key={feature.id} className="p-6 bg-gray-50 rounded-lg space-y-4">
